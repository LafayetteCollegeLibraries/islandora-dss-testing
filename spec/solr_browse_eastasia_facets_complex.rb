...
#    @base_url = "http://digital.stage.lafayette.edu"
  ...
  describe 'browsing search results by any facet within 8 Solr fields for the East Asia Image Collection' do
    ...
    [
     ...
     'Description.Ethnicity'
      ...
      describe 'browsing search results by the initial 5 Solr facets for the field #{field_label} within the East Asia Image Collection' do
        ...
        (1..5).each do |facet_index|
          ...
          it "refines the search by the facet #{facet_index} for faceted field #{field_label}" do
            ...
            # The list must be located by the field label
            # "/html/body/div[2]/div/div/div/div/section/div"
            # subject_lcsh_elem = @driver.find_element(:xpath, "//ul[@class='islandora-solr-facet-list'][#{field_index}]/li[#{facet_index}]/a")
            # subject_lcsh_elem = @driver.find_element(:xpath, '/html/body/div[2]/div/div/div/div/section/div[text()="#{field_label}"]')
