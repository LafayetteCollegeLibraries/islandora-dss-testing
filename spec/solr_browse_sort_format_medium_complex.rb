...
describe "SolrBrowseSortFormatMediumComplex" do
  ...
  describe "Refining browsed items sorted by fields" do
    ...
    collection_fields = [
                        ...
                        ].each do |collection_fields|

      collection_name = collection_fields.keys.shift

      describe "Refining browsed items sorted by fields within #{collection_name}" do

        fields = collection_fields.values.shift
