...
describe "SolrBrowseMdlPrintsFacetSubjectLcsh" do
  ...
  describe 'browsing search results by any facet within 4 Solr fields for the Marquis de Lafayette Prints Collection' do
    ...
    [
     ...
     'Creator',
      ...
      describe 'browsing search results by the initial 5 Solr facets for the field #{field_label} within the Marquis de Lafayette Prints Collection' do
